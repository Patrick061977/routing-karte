...
/* --------------------------------------------------------------
  ...
  // PHP 8.0+ Kompatibilitaet: get_magic_quotes_gpc() wurde entfernt.
  // Seit PHP 7.4 gab die Funktion immer false zurueck, daher ist
  // der addslashes-Block nicht mehr noetig.
